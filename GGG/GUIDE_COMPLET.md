...
3. **Optimisation**
   ...
   - Pré-calculer les entropies pour aller plus vite

4. **Multi-langue**
   - Support de dictionnaires en plusieurs langues
   - Adaptation des stratégies selon la langue

---

## ❓ Questions fréquentes

**Q : Pourquoi utiliser un CSP plutôt qu'un simple filtrage ?**
R : Le CSP permet de modéliser formellement les contraintes et de les combiner facilement. C'est plus maintenable et extensible.

**Q : Pourquoi l'entropie est-elle importante ?**
R : Elle permet de quantifier mathématiquement quel mot est le "meilleur" à jouer. Sans ça, on ferait des choix arbitraires.

**Q : Pourquoi simuler le LLM au lieu de vraiment l'utiliser ?**
R : Pour que le code fonctionne sans API key et sans coût. Tu peux facilement remplacer par un vrai LLM après.

**Q : Le programme peut-il perdre ?**
R : Avec une bonne stratégie, il devrait toujours trouver en 6 coups maximum. Si tu entres un feedback incorrect, ça peut échouer.
...
- ✅ CSP pour modéliser les contraintes
- ✅ Entropie pour optimiser les choix
- ✅ LLM (simulé) pour la prise de décision

Le code est commenté, structuré et explicable !
